...
class MainApp(App):
    def build(self):
        ...
        layout_itog = GridLayout(cols=1, spacing=0, size_hint=(.3, 1))
        ...
        delete = Button(text='', markup=True, font_size=35, size_hint=(1, 1),
                        color=[1, 1, 0, 1])
        ...
        lab1 = LabelX(halign="center",
                      ...
                      font_size=35, size_hint=(1, .3), color=[0, 0, 0, 1])
        ...
        def delete_all():
            ...
            label = Label(text='вы уверены, что хотите\nудалить всю информацию?', font_size=42, size_hint=(1, 1),
                          color=[1, 0, 0, 1])
            yes = Button(text='да', halign="center", font_size=30, size_hint=(1, .8), width=160, height=100)
            no = Button(text='нет', halign="center", font_size=30, size_hint=(1, .8), width=160, height=100)
            ...
            popupWindow = Popup(title="внимание!", size_hint=(None, None), size=(750, 350),
            ...
            def dele():
                with open('tabel_sotrudnikov_november.txt', 'w'):
        ...
        def create_tabel():
            ...
            for i in range(31):
                hours = hours + '-'
            with open('tabel_sotrudnikov_november.txt', 'a+') as k:
        ...
        def vivod_sotrudnikov():
            ...
            if year != 'выберите год' and month != 'выберите месяц':
                py = year
                pm = month
                with open('tabel_sotrudnikov_november.txt', 'r') as k:
                    f = k.read()
                    if data in f:
                        sp_all = f.splitlines()
        ...
        def setka(i1, i2):
            ...
            for i in range(i1, i2):
                ...
                for j in range(3):
                    if j == 0 or j == 2:
                        ...
                        entry[i, j] = LabelX(halign="center", font_size=40, size_hint=(1, 1), color=[0, 0, 1, 1],
                                             width=50, text='часы_' + str(
                                i - 1))  # multiline=False, cursor_color=[0, 0, 1, 1],
            ...
            for i in range(32):
                ...
                for j in range(i1, i2):
                    num[i, j] = TextInput(halign="center", cursor_color=[0, 0, 1, 1], font_size=50, size_hint=(1, 1),
            ...
            for i in range(i2):
                itog[i] = LabelX(halign="right", height=61, width=130, font_size=35, size_hint=(None, None),
                                 color=[1, 0, 0, 1])
        ...
        def add(r, c):
            ...
            with open("tabel_sotrudnikov_november.txt", "r") as f:
                lines = f.readlines()
                with open("tabel_sotrudnikov_november.txt", "w") as f1:
                    for line in lines:
