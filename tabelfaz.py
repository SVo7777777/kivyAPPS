    ...
    def butt_del(self, i, j):
        ...
        def delete(r, c):
            ...
            if self.entry[r, c - 2].text == '':
                ...
                popupWindow = Popup(title=f"Вы уверены, что хотите удалить '{sotrudnik.upper()}'? ",
                                    size_hint=(None, None), size=(400, 220),
        ...
        for i in range(i1, i2):
            ...
            for j in range(3):
                if j == 0 or j == 2:
                    ...
                    self.entry[i, j] = LabelX(halign="center", font_size=35, size_hint=(1, 1), color=[0, 0, 0, 1],
                                              width=50,
