    ...
    for i in range(i1, i2):
        ...
        for j in range(6):
            if j == 5:
                ...
                entry[i, j] = LabelX(halign="center", font_size=50, size_hint=(None, None), height=60, width=80, color=[0, 0 ,0, 1])
        ...
        entry[0, 0].set_bgcolor(1, 0.6, 1 ,1) 
        ...
        if k == 11:
            ...
            if f == 0:                
                if entry[z, f].text == '':
                    ...
                    entry[r, 2].set_bgcolor(1, 0.6, 1, 1)                  
                    for n in range(1, 14):
                        vvsimbol(n, 2, r)
            elif f == 2:
                if entry[z, f].text == '':
                    ...
                    entry[r+1, 0].set_bgcolor(1, 0.6, 1, 1)
                    r = r + 1
            ...
            entry[z, f].set_bgcolor(1, 0.6, 1, 1)
    except KeyError:
        print('end')
